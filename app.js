...
function warmCurrentFlow(){
  ...
  if(p==='screen02.html')preload(`./assets/screen03-${key}.png`);
...
window.BR={CHARACTERS,RUNNERS,selected,selectRunner,go,flash,toast,selectSound,confirmSound,scanSound,errorSound,preload,setArt,preloadNext};
