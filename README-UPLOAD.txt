...
9) Screen 07 digit boxes:
   - تم استبدال صورة Screen 07 بصورة نظيفة بدون الأرقام المطبوعة.
   - كل رقم يتم حقنه برمجيًا داخل مربع مستقل وفي المنتصف: خانتان للدقائق + 3 خانات للأمتار.

10) Scan camera / Back:
   - منطقة الكاميرا في Screen 05 كبرت مع الحفاظ على تمركزها داخل منطقة الـQR المطبوعة.
   - Back hotspot في Screen 05 مطابق للدائرة المطبوعة، وBack في Screen 06 مطابق للزر الأحمر المستطيل.

11) Reward sound:
   - تمت إضافة reward-levelup.mp3 المرفق.
   - يتم تشغيله مع ظهور Screen 06 بعد نجاح الـQR، بدل تداخل صوت مولد آخر معه.
