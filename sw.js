const CACHE='barameel-run-shell-v16';
const SHELL=['./','./index.html','./screen02.html','./screen03.html','./screen04.html','./screen05.html','./screen06.html','./screen07.html','./app.js','./checkpoints.js','./styles.css','./sw.js','./assets/screen05-brona.png','./assets/screen06-base.png','./assets/screen07.png','./assets/checkpoint-ego-qr.png','./assets/checkpoint-ego.jpg','./assets/reward-levelup.mp3'];
